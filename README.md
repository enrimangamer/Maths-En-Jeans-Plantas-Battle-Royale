...
- Enter a username and a password and then click "Enter" on keyboard to place a plant.
- Repeat this process with the same username and password to access the plant's stats. Each line represents 1 "generation" in the future, so the first line represents the next time the roots will grow, the second line the second time the roots will grow, etc... Then, on each line, click on the leftmost percentage to increase the odds of the plant going left, the middle percentage to increase the odds of the plant going right, and the rightmost percentage to increase the odds of the plant winning an encounter with another plant.
